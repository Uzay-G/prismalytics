...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Galena web application."
  #
  #
  ...
  #
  # settings.secret_key_base= u2vcG1nFhzAkfSRm-Xcf2qPxbzdnzKDr3UcVehA4VF0
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("galena.log", "w"))
  #
  #
end
